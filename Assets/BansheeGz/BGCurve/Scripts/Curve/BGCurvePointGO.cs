...
namespace BansheeGz.BGSpline.Curve
{
    ...
    public class BGCurvePointGO : MonoBehaviour, BGCurvePointI
    {
        ...
        //all fields values
        private BGCurvePoint.FieldsValues ValuesForFields
        {
            get
            {
        ...
        {
            return BGCurvePoint.FieldTypes.GetField(curve, type, name, ValuesForFields);
        }
        ...
        public void SetField(string name, object value, Type type)
        {
            ...
            BGCurvePoint.FieldTypes.SetField(curve, type, name, value, ValuesForFields);
        ...
        //Init with data. No events are fired. point==null for pointsMode switching. Do not remove it, it's used via reflection
        private void Init(BGCurvePoint point, BGCurve.PointsModeEnum pointsMode)
        {
            if (point != null)
            {
                // init from new point
